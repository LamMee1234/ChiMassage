<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="viewReservation.aspx.cs" Inherits="Massage_Reservation_System.viewReservation" %>
        ...
        <div>
            ...
            <asp:GridView ID="GridView1" style="text-align:center" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" DataKeyNames="serv_ID" ForeColor="Black" GridLines="Vertical" Width="100%" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" EmptyDataText="There is nothing to edit.">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="reserve_ID" HeaderText="Reserve ID" SortExpression="reserve_ID" InsertVisible="False" ReadOnly="True" />
                    ...
                    <asp:BoundField DataField="addRequest" HeaderText="Add. Request" SortExpression="addRequest" />
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="reserve_ID" DataNavigateUrlFormatString="resCon.aspx?Id={0}" Text="Action">
