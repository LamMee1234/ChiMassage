<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="Massage_Reservation_System.adminLogin" %>
...
<head runat="server">
    ...
    <title>Admin Login | Chi Massage</title>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-1">
                                                ...
                                                <span <%--class="h1 fw-bold mb-0"--%> style="font-family: cursive; font-weight: 700; font-size: 40px">Chi Massage Administrator</span>
                                            </div>

                                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign into your account</h5>

                                            <div class="form-outline mb-4">
                                                <asp:TextBox ID="txtEmail" class="form-control form-control-lg" runat="server" placeholder="Enter Username"></asp:TextBox>
...
<%--                                            <a class="small text-muted" href="forgotPassword.aspx">Forgot password?</a>--%>
                                            <p class="mb-5 pb-lg-2" style="color: #393f81;">
                                               <%-- Don't have an account? <a href="RegistrationPage.aspx"
                                                ...
                                                <br/>Customer login? <a href="LoginPage.aspx"
