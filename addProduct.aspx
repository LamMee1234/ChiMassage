<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="addProduct.aspx.cs" Inherits="Massage_Reservation_System.addProduct" %>
                ...
                <tr>
                    ...
                    <td>
                        <table id="right-panel">
                            ...
                            <tr>
                                <td class="auto-style4">
                                    <asp:Button ID="btnUpdate" runat="server" Text="Add" OnClick="btnUpdate_Click" CssClass="button"/>
                                </td>
                            </tr>
